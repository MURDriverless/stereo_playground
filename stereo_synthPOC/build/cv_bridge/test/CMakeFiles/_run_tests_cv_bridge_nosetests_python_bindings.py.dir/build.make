...
test/CMakeFiles/_run_tests_cv_bridge_nosetests_python_bindings.py:
	cd /workspace/stereo_synthPOC/build/cv_bridge/test && ../catkin_generated/env_cached.sh /usr/bin/python2 /opt/ros/melodic/share/catkin/cmake/test/run_tests.py /workspace/stereo_synthPOC/build/cv_bridge/test_results/cv_bridge/nosetests-python_bindings.py.xml "\"/opt/cmake-3.18.2-Linux-x86_64/bin/cmake\" -E make_directory /workspace/stereo_synthPOC/build/cv_bridge/test_results/cv_bridge" "/usr/bin/nosetests-2.7 -P --process-timeout=60 /workspace/stereo_synthPOC/src/stereo_synthPOC/mur_stereo_acq_right/src/cv_bridge/test/python_bindings.py --with-xunit --xunit-file=/workspace/stereo_synthPOC/build/cv_bridge/test_results/cv_bridge/nosetests-python_bindings.py.xml"
...
test/CMakeFiles/_run_tests_cv_bridge_nosetests_python_bindings.py.dir/clean:
	cd /workspace/stereo_synthPOC/build/cv_bridge/test && $(CMAKE_COMMAND) -P CMakeFiles/_run_tests_cv_bridge_nosetests_python_bindings.py.dir/cmake_clean.cmake
...
test/CMakeFiles/_run_tests_cv_bridge_nosetests_python_bindings.py.dir/depend:
	cd /workspace/stereo_synthPOC/build/cv_bridge && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /workspace/stereo_synthPOC/src/stereo_synthPOC/mur_stereo_acq_right/src/cv_bridge /workspace/stereo_synthPOC/src/stereo_synthPOC/mur_stereo_acq_right/src/cv_bridge/test /workspace/stereo_synthPOC/build/cv_bridge /workspace/stereo_synthPOC/build/cv_bridge/test /workspace/stereo_synthPOC/build/cv_bridge/test/CMakeFiles/_run_tests_cv_bridge_nosetests_python_bindings.py.dir/DependInfo.cmake --color=$(COLOR)
