...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/stereo_synthPOC/src/stereo_synthPOC/mur_stereo_acq_right/src/cv_bridge/include;/usr/local/include/opencv4".split(';') if "/workspace/stereo_synthPOC/src/stereo_synthPOC/mur_stereo_acq_right/src/cv_bridge/include;/usr/local/include/opencv4" != "" else []
...
PROJECT_SPACE_DIR = "/workspace/stereo_synthPOC/devel/.private/cv_bridge"
