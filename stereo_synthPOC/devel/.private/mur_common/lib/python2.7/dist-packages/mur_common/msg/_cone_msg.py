...
"""autogenerated by genpy from mur_common/cone_msg.msg. Do not edit."""
import codecs
import sys
...
class cone_msg(genpy.Message):
  _md5sum = "5e84e87d4b24423a16fef8327b191686"
  _type = "mur_common/cone_msg"
...
string frame_id
"""
  __slots__ = ['header','x','y','colour','frame_id']
  _slot_types = ['std_msgs/Header','float32[]','float32[]','string[]','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(cone_msg, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.colour)
      buff.write(_struct_I.pack(length))
      for val1 in self.colour:
        length = len(val1)
