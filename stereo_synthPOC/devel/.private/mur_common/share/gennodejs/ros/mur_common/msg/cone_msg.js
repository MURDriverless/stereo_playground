...
class cone_msg {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.string(obj.colour, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.colour = _arrayDeserializer.string(buffer, bufferOffset, null)
  ...
  static Resolve(msg) {
    ...
    const resolved = new cone_msg(null);
