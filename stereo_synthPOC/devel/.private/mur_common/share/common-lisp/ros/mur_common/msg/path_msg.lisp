...
(cl:defmethod cl:initialize-instance :after ((m <path_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'path_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mur_common-msg:<path_msg> is deprecated: use mur_common-msg:path_msg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <path_msg>))
...
(cl:defmethod v-val ((m <path_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mur_common-msg:v-val is deprecated.  Use mur_common-msg:v instead.")
  (v m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<path_msg>)))
  ...
  "7c2b271693e8134a76ca46893ed8499c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'path_msg)))
  "Returns md5sum for a message object of type 'path_msg"
  "7c2b271693e8134a76ca46893ed8499c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<path_msg>)))
  ...
  (cl:format cl:nil "Header header~%~%float32[] x # path x coordinate~%float32[] y # path y coordinate~%float32[] v # path desired velocity at point~%~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'path_msg)))
  "Returns full string definition for message of type 'path_msg"
  (cl:format cl:nil "Header header~%~%float32[] x # path x coordinate~%float32[] y # path y coordinate~%float32[] v # path desired velocity at point~%~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
