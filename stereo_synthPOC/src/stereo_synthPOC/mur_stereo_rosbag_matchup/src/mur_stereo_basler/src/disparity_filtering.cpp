...
const String keys =
    ...
    "{@left          |/images/CameraLeft0000_L.png | left view of the stereopair                }"
    "{@right         |/images/CameraRight0014_R.png | right view of the stereopair              }"
...
int main(int argc, char** argv)
{
    ...
    // just use absolute file paths 
    // String left_im = "/workspace/stereo_synthPOC/src/stereo_synthPOC/mur_stereo_rosbag_matchup/build/images/CameraLeft0000_L.png";
    // String right_im = "/workspace/stereo_synthPOC/src/stereo_synthPOC/mur_stereo_rosbag_matchup/build/images/CameraRight0014_R.png";

    String left_im = "/workspace/stereo_synthPOC/src/stereo_synthPOC/mur_stereo_rosbag_matchup/build/images/ambush_5_left.jpg";
    String right_im = "/workspace/stereo_synthPOC/src/stereo_synthPOC/mur_stereo_rosbag_matchup/build/images/ambush_5_right.jpg";
    ...
    if ( left.empty() )
    {
        cout<<"Cannot read image file: "<< left_im << endl;
        return -1;
    }
    ...
    if ( right.empty() )
    {
        cout<<"Cannot read image file: "<< right_im << endl;
        return -1;
    }
    //! [load_views]
    ...
    Mat conf_map = Mat(left.rows,left.cols,CV_8UC3);
    conf_map = Scalar(255);
    Rect ROI;
